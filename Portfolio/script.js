$(document).ready(function() {
  ...
  var projectData = [{
      title: 'Assignment 1',
      text: '<p>Choose and read one of the two following articles: <br/><br/> Design is dead. And we have killed it. <br/><br/> Stop Talking to Each Other and Start Buying Things <br/><br/> Write a personal response/rebuttal the author perspective, and include specific references to ideas in the writing.</p> <strong>Code:</strong> HTML5, CSS3<br>',
    
      image: ['AI Apocalypse.jpg'],
      site: ['Live Site', 'fa-link', 'Assignment 1/index.html']
